...
if (isset($_POST['login'])) 
{
    ...
    $query = mysqli_query($connection,"SELECT mskh,hotenkh, password FROM khachhang WHERE hotenkh='$hotenkh'");
    ...
    <div class="main">
        ...
        <div class="body">
            ...
            if(isset($_GET['previouspage']))
                ...
                $previouspage='';
            echo '
                <form action="login.php?do=login&previouspage='.$previouspage.'" method="post" class="auth-container">
               '; ?>
                <!-- Login form  -->
                    ...
                    <div class="auth-form__container">
                        ...
                        <div class="auth-form__form">
                            <div class="auth-form__group">
                                <input type="text" class="auth-form__input" placeholder="Nhập tên đăng nhập" name="hotenkh" required>
                            </div>
                        </div>
                        <div class="auth-form__form">
                            <div class="auth-form__group">
